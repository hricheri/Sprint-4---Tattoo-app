            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">This is your studio's city — it'll be shown on your profile.</p>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="studio_description" name="studio_description" rows="3"
                            class="w-full rounded-xl border-gray-300 focus:border-lavender-400 focus:ring-lavender-400"
                            placeholder="Describe your studio's vibe, style, equipment...">{{ old('studio_description') }}</textarea>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="home_description" name="home_description" rows="3"
                            class="w-full rounded-xl border-gray-300 focus:border-lavender-400 focus:ring-lavender-400"
                            placeholder="Describe the space, neighborhood, what to expect...">{{ old('home_description') }}</textarea>
