...
<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <form method="POST" action="{{ route('artist-profile.update') }}" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="bio" name="bio" rows="3"
                            class="w-full rounded-xl border-gray-300 focus:border-lavender-400 focus:ring-lavender-400">{{ old('bio', $artist->bio) }}</textarea>
            ...
            {{-- === FEATURES === --}}
            <div x-data="{
                    studioFeatures: {{ Illuminate\Support\Js::from(old('studio_features', $artist->studio->features->pluck('id'))) }},
                    preferences: {{ Illuminate\Support\Js::from(old('feature_preferences', $artist->featurePreferences->pluck('id'))) }},
